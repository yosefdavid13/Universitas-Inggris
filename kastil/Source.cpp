...
void tampil(void)
{
    ...
    glVertex3f(-90.0, 70.0, 30.0);      // TINGGI BANGUN 70
    glVertex3f(-60.0, 70.0, 30.0);
    ...
    // BANGUN KACA KIRI (1)   // BELUM DIUBAH KACA
    glBegin(GL_QUADS);
    glColor3f(0.70, 0.42, 0.39);
    glVertex3f(65.0, -20.0, -30.0);
